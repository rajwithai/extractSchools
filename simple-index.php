...
$path = str_replace('/simple-index.php', '', $path);
if (empty($path)) $path = '/';
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div style="text-align: center; margin: 40px 0;">
                    <a href="?page=status" class="btn btn-success">🔍 Check Live Data Source Status</a>
                    <a href="?page=about" class="btn">📖 Technical Documentation</a>
                    <a href="?page=fetch" class="btn">🌍 Fetch Latest School Data</a>
                </div>
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div style="text-align: center; margin-top: 30px;">
                    ...
                    <a href="?page=fetch" class="btn">🌍 Fetch School Data</a>
                </div>
            </div>
        </div>
    </body>
